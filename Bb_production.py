...
#     # print(bb.get_course_enrollment('courseId:TEEL_Advising'))
#     # print(bb.get_course_enrollment())
#     # print(bb.remove_gradebook_columns())
#     # print(bb.get_gradebook_columns())
#     # print(bb.get_user_enroolment())
#     # print(bb.get_data_sources('externalId:SIS_I2017'))
#     # print(bb.get_courseid('courseId:NURS631L_VA_S2015'))
#     # print(bb.get_course_enrollment('courseId:GSCI340_VA_S2018'))
#     # print(bb.create_course_memberships('courseId:TEEL363_VA_S2019','userName:teel001'))
#     # batch_add_user()
#     # move_enrollment_to_organ()
#     # batch_create_user()
#     # batch_add_students()
